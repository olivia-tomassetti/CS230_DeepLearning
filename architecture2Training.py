...
def intuModel(Tx, n_a):
    ...
    h = Bidirectional(LSTM(n_a, return_sequences=True))(X)
    
    # Dropout for regularization
    h = Dropout(0.2)(h) # for regularization
    ...
    # Third LSTM layer
    h = LSTM(100, return_sequences=False)(h)
    
    # Dropout for regularization
    h = Dropout(0.2)(h) # for regularization

    # Final Dense layer with Softmax activation for 4 classes
    out = (Dense(4))(h)
